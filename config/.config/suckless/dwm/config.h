...
static const char *fonts[]          = { "jetBrainsMono Nerd Font:style=bold:size=11:antialias=true" };
static const char dmenufont[]       = "jetBrainsMono Nerd Font:style=bold:size=11:antialias=true;";
...
static const char *terminal2cmd[]    = { "wezterm", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,             XK_Return,  spawn,    {.v = terminal2cmd } },
  ...
  /* layouts */
  { ControlMask,                  XK_t,      setlayout,      {.v = &layouts[0]} },
	{ ControlMask,                  XK_f,      setlayout,      {.v = &layouts[1]} },
	{ ControlMask,                  XK_m,      setlayout,      {.v = &layouts[2]} },
	{ ALTKEY|ControlMask,           XK_t,      togglefloating, {0} },
